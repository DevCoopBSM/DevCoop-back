...
router.post("/", async (req, res) => {
  ...
  const insertPayLogQuery = 'INSERT INTO pay_log(code_number, date, type, inner_point, point, charger_id, verify_key ,student_name) VALUES(?, CURRENT_TIMESTAMP, 0, ?, ?, ?, "test", ?)';
  ...
  try {
    ...
    await executeQueryPromise(insertPayLogQuery, [code_number, minusPoint, value.point, charger_id, value.student_name]);
